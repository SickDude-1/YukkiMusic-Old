...
def start_pannel():  
    buttons = [
            ...
            [ 
                InlineKeyboardButton(text="📣 Channel", url="https://t.me/cheemsxbots"),
                InlineKeyboardButton(text="💭 Group", url="https://t.me/cheemsxsupport")
            ],
    ]
...
pstart_markup = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "➕ Add me to your Group ➕", url="https://t.me/cheemsxrobot?startgroup=true")
                ],[
                    InlineKeyboardButton(
                    ...
                    InlineKeyboardButton(
                        "👥 Official Group", url="https://t.me/cheemsxsupport"), 
                    InlineKeyboardButton(
                        "📎 Official Channel", url="https://t.me/cheemsxbots")
                ],
            ]
        )
